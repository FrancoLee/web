...
<title>新增图片</title>
<link href="/back/lib/webuploader/0.1.5/webuploader.css" rel="stylesheet" type="text/css" />
</head>
<body>
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add" action="/back/adv/addCarousel" method="post">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="0" placeholder="" id="rank" name="rank">
			</div>
		</div>
		...
		<%--<div class="row cl">--%>
			...
			<%--<div class="formControls col-xs-8 col-sm-9">--%>
				<%--&lt;%&ndash;<input type="text" class="input-text" value="0" placeholder="" id="" name="">&ndash;%&gt;--%>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				...
				<button onclick="sub()" class="btn btn-primary radius" type="button"><i class="Hui-iconfont">&#xe632;</i> 保存并提交审核</button>
...
<script type="text/javascript" src="/back/lib/jquery.validation/1.14.0/jquery.validate.js"></script>
<script type="text/javascript" src="/back/lib/jquery.validation/1.14.0/validate-methods.js"></script>
<script type="text/javascript" src="/back/lib/jquery.validation/1.14.0/messages_zh.js"></script>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="/back/lib/webuploader/0.1.5/webuploader.min.js"></script>
       ...
       // alert(type)
	    if(info.length<=0)
	        ...
	        var id=$('#id').val();
		 	   $.ajax({
                   type: 'POST',
                   url: '/back/adv/updateCarousel',
                   dataType: 'text',
                   data: {'info':info,'rank':rank,'id':id},
...
(function( $ ){
    ...
    $(function() {
        ...
        uploader = WebUploader.create({
            ...
            dnd: '#dndArea',
            paste: '#uploader',
            swf: '/back/lib/webuploader/0.1.5/Uploader.swf',
            chunked: false,
            chunkSize: 512 * 1024,
            server: '/back/adv/addCarousel',
            // runtimeOrder: 'flash',
            // accept: {
            //     title: 'Images',
            //     extensions: 'gif,jpg,jpeg,bmp,png',
