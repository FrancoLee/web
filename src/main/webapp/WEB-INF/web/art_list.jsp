...
<head>
    ...
    <script src="/js/art_list.js"></script>
                    ...
                    <c:forEach items="${show_art}" var="art">
                        <div class="row info-content">
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-4" style="">
                                ...
                                <p>作者：${art.user}</p>
                                <p>发表时间:${art.time}</p>
                                <button class="btn" onclick="delete_art(${page.index},${art.artId})">删除</button>
                    ...
                    <ul class="pagination">
                        <c:choose>
                            <c:when test="${page.index!=1}">
                                <li><a href="/article/user_art?page=1">首页</a></li>
                                <li><a href="/article/user_art?page=${page.index-1}">上一页</a></li>
                            </c:when>
                            <c:otherwise>
                        ...
                        <c:forEach var="index" begin="${page.pageBeg}" end="${page.pageEnd}" step="1" varStatus="int">
                            <li><a href="/article/user_art?page=${index}">${index}</a></li>
                        </c:forEach>
                        <c:choose>
                            <c:when test="${page.pageEnd!=page.index}">
                                <li><a href="/article/user_art?page=${page.index+1}">下一页</a></li>
                                <li><a href="/article/user_art?page=${page.maxPage}">末页</a></li>
                            </c:when>
                            <c:otherwise>
