                    ...
                    <ul class="pagination">
                        <c:choose>
                            <c:when test="${page.index!=1}">
                                <li><a href="/videoList/new?page=1">首页</a></li>
                                <li><a href="/videoList/new?page=${page.index-1}">上一页</a></li>
                            </c:when>
                            <c:otherwise>
                        ...
                        <c:forEach var="index" begin="${page.pageBeg}" end="${page.pageEnd}" step="1" varStatus="int">
                            <li><a href="/videoList/new?page=${index}">${index}</a></li>
                        </c:forEach>
                        <c:choose>
                            <c:when test="${page.pageEnd!=page.index}">
                                <li><a href="/videoList/new?page=${page.index+1}">下一页</a></li>
                                <li><a href="/videoList/new?page=${page.maxPage}">末页</a></li>
                            </c:when>
                            <c:otherwise>
                            </c:otherwise>
                        </c:choose>
